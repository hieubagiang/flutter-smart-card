...
mixin _$LoginRequest {
  ...
  String? get secretMessage => throw _privateConstructorUsedError;
...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  $Res call({String? signature, String? secretMessage});
}
    ...
    return _then(_value.copyWith(
      signature: signature == freezed
          ...
          : signature // ignore: cast_nullable_to_non_nullable
              as String?,
      secretMessage: secretMessage == freezed
          ? _value.secretMessage
          : secretMessage // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
}
...
class _$_LoginRequest implements _LoginRequest {
  const _$_LoginRequest({this.signature, this.secretMessage});
  ...
  @override
  String toString() {
    return 'LoginRequest(signature: $signature, secretMessage: $secretMessage)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.secretMessage, secretMessage));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(secretMessage));
...
abstract class _LoginRequest implements LoginRequest {
  const factory _LoginRequest(
      {final String? signature, final String? secretMessage}) = _$_LoginRequest;
