...
import 'package:smart_card/app/presentation/pages/tax_transaction/tax_transaction_binding.dart';
...
abstract class AppPages {
  static final pages = [
    GetPage(name: RouteList.signIn, page: () => const LoginScreen(), binding: LoginBinding()),
    GetPage(name: RouteList.connectCard, page: () => const CardConnectScreen(), binding: CardConnectBinding()),
    GetPage(name: RouteList.main, page: () => const MainScreen(), binding: MainBinding()),
    GetPage(name: RouteList.taxScreen, page: () => const TaxScreen(), binding: TaxBinding()),
  ];
}
